...
class App extends React.Component {
    ...
    handleUserInput = (inputValue) => {
        ...
        if (index >= this.state.selecedParagraph.length) {
            this.setState({
                characters,
                words,
            });
        ...
        if (!(index === this.state.selecedParagraph.length - 1))
    ...
    render() {
        return (
            <div className="app">
                <Nav />
                <Landing />
                <ChallengeSection selecedParagraph={this.state.selecedParagraph} words={this.state.words}
                    characters={this.state.characters} wpm={this.state.wpm} timeRemaining={this.state.timeRemaining}
                    timerStarted={this.state.timerStarted} testInfo={this.state.testInfo} onInputChange={this.handleUserInput} startAgain={this.startAgain} />
                <Footer />
            </div>
        )
    }
